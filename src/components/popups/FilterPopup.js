  ...
  return (
    <div className="w-[100px] h-[618px] overflow-hidden max-w-full max-h-full text-left text-smi text-shade-02 font-poppins">
      <div className="absolute top-[110px] left-[20px] bg-shade-01 w-[774px] h-[410px]">
        ...
        <div className="absolute top-[35px] left-[35px] text-xs leading-[70.19%] font-medium text-dimgray-600 flex items-center w-[550px] h-[26.1px]">
        ...
        <div className="absolute top-[247.9px] left-[215px] w-[166px] h-32">
          <div className="absolute top-[-0.5px] left-[-0.5px] rounded-xl bg-shade-01 box-border w-[167px] flex flex-row items-start justify-start p-4 cursor-auto border-[1px] border-solid border-neutral-03 hover:box-border hover:cursor-pointer hover:border-[1px] hover:border-solid hover:border-gray-900 active:bg-silver-100">
            <div className="flex flex-col items-start justify-start gap-[40px]">
              <div className="w-8 relative h-8" alt="" />
        ...
        <div className="absolute top-[100px] left-[35px] w-[702px] h-[51px]" >
          <PriceSliderBar />
        </div>
      </div>
      <div className="absolute top-[493px] left-[18px] w-[778px] h-[117px] text-xs text-black">
        ...
        <button className="cursor-pointer [border:none] p-2.5 bg-darkblue-100 absolute top-[38px] left-[633px] rounded-[9.08px] w-[107px] h-[41px] flex flex-row flex-wrap items-center justify-center box-border hover:bg-blueviolet-100 hover:gap-[10px] hover:cursor-pointer active:bg-midnightblue-500">
