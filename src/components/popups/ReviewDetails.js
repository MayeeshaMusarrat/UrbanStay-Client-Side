const ReviewDetails = ({ onClose }) => {
  return (
    <div className="w-[1167px] relative rounded-3xs h-[631px] overflow-y-auto max-w-full max-h-full overflow-auto text-left text-sm text-black font-poppins">
      <div className="absolute top-[58px] left-[38px] rounded-11xl w-[1069px] h-[515px] flex items-center justify-center">
        <img
          className="w-full h-full object-contain absolute left-[0px] top-[4px] [transform:scale(1.039)]"
          alt=""
          src="/rectangle-108.svg"
        />
      </div>
      <div className="absolute top-[58px] left-[38px] w-[1069px] h-[81px]">
        <div className="absolute top-[0px] left-[5px] rounded-15xl bg-shade-01 w-[1064px] h-20" />
        <img
