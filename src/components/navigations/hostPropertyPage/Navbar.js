  ...
  return (
    <div className="self-stretch h-[93px] flex flex-row items-start justify-start py-0 pr-2 pl-0 box-border max-w-full text-center text-base text-darkslategray-500 font-inter">
      <div className="self-stretch flex-1 rounded-3xs bg-shade-01 shadow-[0px_0px_25px_rgba(0,_0,_0,_0.1)] overflow-hidden flex flex-col items-start justify-start py-[22px] px-[21px] box-border max-w-full">
        <div className="self-stretch flex-1 overflow-x-auto flex flex-row items-start justify-between gap-[20px]">
          <button className="cursor-pointer [border:none] p-2.5 bg-darkblue-100 h-[49px] w-[205px] rounded-[9.08px] shrink-0 flex flex-row flex-wrap items-center justify-center box-border whitespace-nowrap hover:bg-mediumslateblue hover:gap-[10px]">
            <b className="relative text-base capitalize font-inter text-shade-01 text-center whitespace-nowrap">
              Property Information
            </b>
          </button>
          <div
            className="self-stretch w-[205px] rounded-[9.08px] shrink-0 flex flex-row flex-wrap items-center justify-center p-2.5 box-border cursor-pointer hover:bg-blueviolet-200 hover:gap-[10px]"
