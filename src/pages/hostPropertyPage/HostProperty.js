...
const HostProperty = () => {
  return (
    <div className="w-full relative bg-ghostwhite overflow-hidden flex flex-col items-center justify-start pt-0 px-0 pb-px box-border gap-[58px] tracking-[normal] mq750:gap-[58px]">
      ...
      <section className="w-[1462px] flex flex-row items-start justify-start py-0 pr-14 pl-5 box-border shrink-0 max-w-full text-center text-mini text-shade-01 font-inter lg:pr-7 lg:box-border">
        <div className="flex-1 flex flex-col items-start justify-start gap-[61px] max-w-full mq450:gap-[61px] mq750:gap-[61px]">
          ...
          <div className="self-stretch flex flex-row items-start justify-end py-0 px-[30px]">
            <div className="h-[61px] w-[164px] rounded-[9.08px] bg-darkblue-100 flex flex-row flex-wrap items-center justify-center p-2.5 box-border whitespace-nowrap hover:bg-blueviolet-200 hover:gap-[10px]">
